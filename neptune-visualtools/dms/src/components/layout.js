...
export default function Layout({ children, home, login }) {
    ...
    return (
        <div>
                    ...
                    <Container>
                        ...
                        <Navbar.Collapse id="basic-navbar-nav">
                            <Nav className="me-auto">
                                ...
                                <Nav.Link href="/index.html">DMS Schema Mapper</Nav.Link>
            ...
            <footer class="footer">
                <div class="container">
                    <label>contact <a href="mailto:neptune-developer-feedbac@amazon.com">wwso-neptune-ssa@amazon.com</a> for any feedback or questions</label>
                </div>
            </footer>
