...
public class LabelSchemaTest {
    ...
    public void unioningShouldUpdateDataTypesOfExistingProperties(){
        ...
        labelSchema1.put("p1", new PropertySchema("p1", false, DataType.Integer, false, 0, 0));
        labelSchema1.put("p2", new PropertySchema("p2", false, DataType.Integer, false, 0, 0));
        labelSchema1.put("p3", new PropertySchema("p3", false, DataType.Double, false, 0, 0));

        LabelSchema labelSchema2 = new LabelSchema(new Label("my-label"));

        labelSchema2.put("p1", new PropertySchema("p1", false, DataType.Double, false, 0, 0));
        labelSchema2.put("p2", new PropertySchema("p2", false, DataType.Integer, true, 0, 0));
        labelSchema2.put("p3", new PropertySchema("p3", false, DataType.Integer, false, 0, 0));

        LabelSchema result = labelSchema1.union(labelSchema2);

        assertEquals(result.getPropertySchema("p1"),
                new PropertySchema("p1", false, DataType.Double, false, 0, 0));
        assertEquals(result.getPropertySchema("p2"),
                new PropertySchema("p2", false, DataType.Integer, true, 0, 0));
        assertEquals(result.getPropertySchema("p3"),
                new PropertySchema("p3", false, DataType.Double, false, 0, 0));
    }
    ...
    public void unioningShouldAddNewProperties(){
        ...
        labelSchema2.put("p4", new PropertySchema("p4", false, DataType.String, false, 0, 0));
        labelSchema2.put("p5", new PropertySchema("p5", false, DataType.Integer, true, 0, 0));
        ...
        assertEquals(result.getPropertySchema("p4"),
                new PropertySchema("p4", false, DataType.String, false, 0, 0));
        assertEquals(result.getPropertySchema("p5"),
                new PropertySchema("p5", false, DataType.Integer, true, 0, 0));
    }
    ...
    public void schemasWithSameLabelAndPropertySchemasAreSame(){
        ...
        labelSchema2.put("p1", new PropertySchema("p1", false, DataType.Integer, false, 0, 0));
        labelSchema2.put("p2", new PropertySchema("p2", false, DataType.Integer, false, 0, 0));
    ...
    public void schemasWithDifferentPropertiesAreNotSame(){
        ...
        labelSchema2.put("p1", new PropertySchema("p1", false, DataType.Double, true, 0, 0));
    ...
    public void schemasWithDifferentNumberOfPropertiesAreNotSame(){
        ...
        labelSchema3.put("p1", new PropertySchema("p1", false, DataType.Integer, false, 0, 0));
    ...
    public void schemasWithPropertiesWithDifferentNullableCharacteristicsAreNotSame(){
        ...
        labelSchema1.put("p1", new PropertySchema("p1", true, DataType.Integer, false, 0, 0));
        labelSchema1.put("p2", new PropertySchema("p2", false, DataType.Integer, false, 0, 0));
