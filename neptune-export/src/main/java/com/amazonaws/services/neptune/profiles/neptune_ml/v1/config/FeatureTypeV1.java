...
public enum FeatureTypeV1 {
    category{
        @Override
        public void validateOverride(JsonNode node, String description, Label label) {
            // Do nothing
        }
    },
    numerical{
    ...
    public abstract void validateOverride(JsonNode node, String description, Label label);
}
