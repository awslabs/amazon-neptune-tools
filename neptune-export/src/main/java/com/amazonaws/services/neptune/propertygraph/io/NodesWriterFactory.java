...
public class NodesWriterFactory implements WriterFactory<Map<String, Object>> {
    ...
    @Override
    public PropertyGraphPrinter createPrinter(String name, int index, PropertyMetadataForLabel propertyMetadataForLabel, PropertyGraphTargetConfig targetConfig) throws IOException {
        PropertyGraphPrinter propertyGraphPrinter = targetConfig.createPrinterForNodes(name, index, propertyMetadataForLabel);
